...
```{r}
# my cool new function
my_func <- function(x){mean(x^2) - (mean(x))^2}
  # your code here
...
```{r}
clothing_exports <- readRDS("~/Desktop/Rprogramming21_student/Lecture_4/sourcedata/clothing_exports_aggregated.rds")


df_2018 <- clothing_exports %>%
  filter(year == 2018)

df_2018

unique(df_2018$reporter_fullname_english)
