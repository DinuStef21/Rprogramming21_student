...
ggplot(df7, aes(x = gdpPercap, y = lifeExp, color = continent, size = pop)) + scale_x_log10() + geom_point()

ggplot(df6, aes(x= log(gdpPercap), y = lifeExp, color = continent, size = pop)) + geom_point()

ggplot() + geom_point(df6, mapping = aes(x= log(gdpPercap), y = lifeExp, color = continent, size = pop))
...
ggplot(df7, aes(x = log(gdpPercap), y = lifeExp, color = continent, size = pop)) +
