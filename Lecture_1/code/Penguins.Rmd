...
```{r}
ggplot() +
  geom_point(data = penguins, aes (x = flipper_length_mm, y = bill_length_mm, color = "red", size= 3))
```
...
```{r}
ggplot() +
  geom_point(data = penguins, aes (x = flipper_length_mm, y = bill_length_mm, male = "blue", female = "pink"))
```
