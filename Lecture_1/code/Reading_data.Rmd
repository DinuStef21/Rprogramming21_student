...
```{r}
football <- read.csv2("~/Desktop/Rprogramming21_student/Lecture_1/sourcedata/voetbal.csv")
```
...
```{r}
football1 <- read.csv2("~/Desktop/Rprogramming21_student/Lecture_1/sourcedata/N1.csv")
```
...
```{r}
football2 <- read.csv2("~/Desktop/Rprogramming21_student/Lecture_1/sourcedata/N1.csv", sep=",")
```
...
```{r}
football_points <- read_excel("~/Desktop/Rprogramming21_student/Lecture_1/sourcedata/football.xlsx")
```
```{r}
...
```{r}
football_points <- read_excel("~/Desktop/Rprogramming21_student/Lecture_1/sourcedata/football.xlsx", skip = 3)
...
write.csv2(football, file = "~/Desktop/Rprogramming21_student/Lecture_1/sourcedata/Myfootballdata.csv")
...
```{r}
gender <- read.csv2("~/Desktop/Rprogramming21_student/Lecture_1/sourcedata/gender.csv")
head(gender)
```
